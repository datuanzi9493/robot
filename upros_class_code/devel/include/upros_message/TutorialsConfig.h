...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.size = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TutorialsConfig::AbstractParamDescriptionConstPtr(new TutorialsConfig::ParamDescription<int>("size", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'Small', 'type': 'int', 'value': 0, 'srcline': 13, 'srcfile': '/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg', 'description': 'A small constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Medium', 'type': 'int', 'value': 1, 'srcline': 14, 'srcfile': '/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg', 'description': 'A medium constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Large', 'type': 'int', 'value': 2, 'srcline': 15, 'srcfile': '/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg', 'description': 'A large constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ExtraLarge', 'type': 'int', 'value': 3, 'srcline': 16, 'srcfile': '/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg', 'description': 'An extra large constant', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &TutorialsConfig::size)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(TutorialsConfig::AbstractParamDescriptionConstPtr(new TutorialsConfig::ParamDescription<int>("size", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'Small', 'type': 'int', 'value': 0, 'srcline': 13, 'srcfile': '/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg', 'description': 'A small constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Medium', 'type': 'int', 'value': 1, 'srcline': 14, 'srcfile': '/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg', 'description': 'A medium constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Large', 'type': 'int', 'value': 2, 'srcline': 15, 'srcfile': '/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg', 'description': 'A large constant', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ExtraLarge', 'type': 'int', 'value': 3, 'srcline': 16, 'srcfile': '/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg', 'description': 'An extra large constant', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &TutorialsConfig::size)));
...
//#line 13 "/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg"
      const int Tutorials_Small = 0;
//#line 14 "/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg"
      const int Tutorials_Medium = 1;
//#line 15 "/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg"
      const int Tutorials_Large = 2;
//#line 16 "/home/bcsh/upros_class_code/src/upros_message/cfg/Tutorials.cfg"
